...
public class UISkillToolTip : UIToolTip
{
    ...
    [SerializeField] private string lockedSkillText = "You're taken a different path - this skill is now locked!";
    ...
    public void ShowToolTip(bool show, RectTransform targetRect, UITreeNode node)
    {
        ...
        string skillLockedText = GetColoredText(importantInforHex, lockedSkillText);
    ...
    private string GetRequirements(int skillCost, UITreeNode[] neededNodes, UITreeNode[] conflictNodes)
    {
        ...
        sb.AppendLine();
        sb.AppendLine(GetColoredText(importantInforHex, "Locks out: "));
        ...
        foreach (var node in conflictNodes)
        {
            ...
            string nodeText = $"- {node.skillData.displayName}";
            string finalNodeText = GetColoredText(importantInforHex, nodeText);
            sb.AppendLine(finalNodeText);
        }
