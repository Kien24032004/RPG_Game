...
public class SkillSwordThrow : SkillBase
{
    ...
    [SerializeField] private float spaceBetweenDot = 0.5f;
    ...
    public void PredictTrajectory(Vector2 direction)
    {
        ...
        {
            dots[i].position = GetTrajectoryPoint(direction, i * spaceBetweenDot);
        }
    }
